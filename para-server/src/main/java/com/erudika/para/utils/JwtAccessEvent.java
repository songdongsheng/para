...
public class JwtAccessEvent implements Serializable, IAccessEvent {
    ...
    public JwtAccessEvent(HttpServletRequest httpRequest, HttpServletResponse httpResponse, ServerAdapter adapter) {
